...
public class AdminController {
	...
	//view user details by id (Exception handled but not give a proper message to admin)
	@GetMapping(value="/admin/{aid}/user/{uid}")
	public User getUser(@RequestParam String adminName,@RequestParam String password,@PathVariable long uid,@PathVariable long aid) throws EntityNotFoundException{
	...
	public AccountDetails getUserAccountDetails(@RequestParam String adminName,@RequestParam String password,@PathVariable long accountNumber,@PathVariable long aid){
...
//	public String registerUser1(@RequestParam String adminName,@RequestParam String password,@PathVariable long aid,@RequestBody UserVO uservo) {
...
//	}
	...
	@PostMapping(value="/admin/{aid}/user/{baid}/createUserAccount")
	public String createaccount(@RequestParam String adminName,@RequestParam String password,@PathVariable long baid,@RequestBody AccountDetailsVO accountDetailsvo,@PathVariable long aid) {
		return adminRepoImp.createAccount(adminName,password,baid, accountDetailsvo, aid);
	}
	
	//delete account of user
	
	@DeleteMapping(value="/admin/{aid}/deleteUserAccount")
	public String deleteAccountDetails(@RequestParam String adminName,@RequestParam String password,@RequestParam long accountNumber,@PathVariable long aid){
	...
	public String deleteUser(@RequestParam String adminName,@RequestParam String password,@PathVariable long uid,@PathVariable long aid){
